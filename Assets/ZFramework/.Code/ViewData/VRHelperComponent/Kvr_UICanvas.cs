...
namespace KVR_UI
{
    public class Kvr_UICanvas : MonoBehaviour
    {
        ...
        protected virtual void SetupCanvas()
        {
            ...
            var customRaycaster = canvas.gameObject.GetComponent<Kvr_UIGraphicRaycaster>();


            if (!customRaycaster)
            {
                customRaycaster = canvas.gameObject.AddComponent<Kvr_UIGraphicRaycaster>();
            }
