...
namespace ZFramework
{
    ...
    internal class IdGenerater
    {
        ...
        public long GenerateInstanceId()
        {
            ...
            InstanceIdStruct instanceIdStruct = new InstanceIdStruct(this.lastInstanceIdTime,0 /*Game.Options.Process*/, this.instanceIdValue);
        ...
        public long GenerateId()
        {
            ...
            IdStruct idStruct = new IdStruct(this.lastIdTime, 0 /* Game.Options.Process*/, value);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct = new UnitIdStruct(zone, 0/*Game.Options.Process*/, this.lastUnitIdTime, this.unitIdValue);
