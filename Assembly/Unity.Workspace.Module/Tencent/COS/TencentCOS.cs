...
namespace ZFramework
{
    ...
    public class TencentCOS
    {
        ...
        public TencentCOS(string appid,string secretId,string secretKey,string region,string bucket)
        {
            APPID = appid;
            SecretId = secretId;
            SecretKey = secretKey;
        ...
        void GenerateListAndMapString(Dictionary<string, string> headers, out string KeyList, out string Map)
        {
            ...
            list.Sort(StringComparer.Create(CultureInfo.CurrentCulture, CompareOptions.None));
